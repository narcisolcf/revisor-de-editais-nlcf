...
const loggingService = new LoggingService_1.LoggingService('analysis-config-api');
const metricsService = new MetricsService_1.MetricsService('analysis-config-api');
