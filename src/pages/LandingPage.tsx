          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
              ...
              <div className="@[480px]:p-4">
                ...
                >
                  ...
                  <button
                    ...
                    className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-[#1543b7] text-[#f8f9fc] text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em]"
                  >
            ...
            <div className="flex flex-wrap gap-4 p-4">
              <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-lg p-6 bg-[#e7ebf3]">
                <p className="text-[#0e121b] text-base font-medium leading-normal">Documentos Revisados</p>
                <p className="text-[#0e121b] tracking-light text-2xl font-bold leading-tight">1,500+</p>
              </div>
              <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-lg p-6 bg-[#e7ebf3]">
                <p className="text-[#0e121b] text-base font-medium leading-normal">Órgãos Atendidos</p>
                <p className="text-[#0e121b] tracking-light text-2xl font-bold leading-tight">50+</p>
              </div>
            </div>

            {/* Services Section */}
            <h2 className="text-[#0e121b] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Nossos Principais Serviços</h2>
            
            <div className="p-4">
              <div className="flex items-stretch justify-between gap-4 rounded-lg">
                <div className="flex flex-col gap-1 flex-[2_2_0px]">
                  <p className="text-[#4e6397] text-sm font-normal leading-normal">Revisão de Editais</p>
                  <p className="text-[#0e121b] text-base font-bold leading-tight">Análise Detalhada</p>
                  <p className="text-[#4e6397] text-sm font-normal leading-normal">
            ...
            <div className="p-4">
              <div className="flex items-stretch justify-between gap-4 rounded-lg">
                <div className="flex flex-col gap-1 flex-[2_2_0px]">
                  <p className="text-[#4e6397] text-sm font-normal leading-normal">Revisão de Termos de Referência</p>
                  <p className="text-[#0e121b] text-base font-bold leading-tight">Especificações Claras</p>
                  <p className="text-[#4e6397] text-sm font-normal leading-normal">
            ...
            <div className="p-4">
              <div className="flex items-stretch justify-between gap-4 rounded-lg">
                <div className="flex flex-col gap-1 flex-[2_2_0px]">
                  <p className="text-[#4e6397] text-sm font-normal leading-normal">Consultoria Especializada</p>
                  <p className="text-[#0e121b] text-base font-bold leading-tight">Suporte Contínuo</p>
                  <p className="text-[#4e6397] text-sm font-normal leading-normal">
            ...
            <div className="@container">
              <div className="flex flex-col justify-end gap-6 px-4 py-10 @[480px]:gap-8 @[480px]:px-10 @[480px]:py-20">
                <div className="flex flex-col gap-2 text-center">
                  <h1 className="text-[#0e121b] tracking-light text-[32px] font-bold leading-tight @[480px]:text-4xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em] max-w-[720px]">
                    Solicite uma Análise Gratuita
                  </h1>
                  <p className="text-[#0e121b] text-base font-normal leading-normal max-w-[720px]">
                    Descubra como podemos ajudar a garantir o sucesso de suas licitações. Solicite uma análise gratuita de seus documentos.
                  </p>
                </div>
                <div className="flex flex-1 justify-center">
                  <div className="flex justify-center">
                    <button
                      onClick={handleRequestAnalysis}
                      className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-[#1543b7] text-[#f8f9fc] text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em] grow"
                    >
                      <span className="truncate">Solicitar Análise Gratuita</span>
                    </button>
                  </div>
          ...
          <div className="flex max-w-[960px] flex-1 flex-col">
            <footer className="flex flex-col gap-6 px-5 py-10 text-center @container">
              <div className="flex flex-wrap items-center justify-center gap-6 @[480px]:flex-row @[480px]:justify-around">
                <a className="text-[#4e6397] text-base font-normal leading-normal min-w-40" href="#">Política de Privacidade</a>
                <a className="text-[#4e6397] text-base font-normal leading-normal min-w-40" href="#">Termos de Serviço</a>
                <a className="text-[#4e6397] text-base font-normal leading-normal min-w-40" href="#">Contato</a>
              </div>
              ...
              <p className="text-[#4e6397] text-base font-normal leading-normal">© 2024 GovDocs. Todos os direitos reservados.</p>
            </footer>
          </div>
        </footer>
      </div>
